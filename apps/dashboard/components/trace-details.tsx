...
import type { ConsoleSettings, ExecutionDetail, ModelPolicy, ModelTarget, RuntimeIntervention, RuntimeRecoveryRequest, RuntimeRecoveryResult } from "@/lib/types";
...
export function TraceDetails({ detail, settings, intervention, modelPolicies, modelTargets, onBack, onCancel, onOpenExecution, onRecover }: TraceDetailsProps) {
  ...
  return <div className="trace-view view-enter">
    ...
    {intervention && <InterventionWorkbench intervention={intervention} key={intervention.executionId} modelPolicies={modelPolicies} modelTargets={modelTargets} onOpenExecution={onOpenExecution} onRecover={onRecover} />}
  </div>;
}
